# Listing 8.7: RWMutex protection
...
+
 ...
 func (s *Shortener) Resolve(ctx context.Context, key Key) (Link, error) {
 	if key.Empty() {
...
## [link](https://github.com/inancgumus/gobyexample/blob/2dc907a67dd40a92623120a434bec77446b114e7/link) / [shortener.go](https://github.com/inancgumus/gobyexample/blob/2dc907a67dd40a92623120a434bec77446b114e7/link/shortener.go)
